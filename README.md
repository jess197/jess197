...
- :computer: Database Knowledges: - Oracle PLSQL, MySQL, T-SQL, PostgreSQL, Data Modelling and Data Structures 
  ...
  - NoSQL: MongoDB, Redis
- :computer: Data Engineering applications: Python, ETL/ELT, Airflow, Dagster, Databricks, dbt, Snowflake, Hadoop, Pyspark.
- :computer: Data Engineering concepts: Big Data, Data Governance, Data Architecture, Modern Data Stack 
- :computer: Cloud AWS Knowledges: AWS (Kinesis Firehose, Glue, Athena, IAM, EKS, EC2, Redshift, S3, CloudWatch, Quicksight),
- :computer: Cloud Azure Knowledges: (Storage Account, Blob Storage, Event Hub, Stream Analytics, Data Factory, Cost Management, Synapse Analytics) 
...
<img src="./logos/snowflake.png" alt="snowflake" style="vertical-align:top; margin:4px; height:40px; width:40px">
...
<img src="./logos/dagster.png" alt="dagster" style="vertical-align:top; margin:4px; height:40px; width:40px">
